...
#define TESIC_APB_CFG_SLAVE_ITEN_MASK (((uint32_t)1)<<TESIC_APB_CFG_SLAVE_ITEN_POS)

#define TESIC_APB_CFG_MASTER_ITEN_POS 20
#define TESIC_APB_CFG_MASTER_ITEN_MASK (((uint32_t)1)<<TESIC_APB_CFG_MASTER_ITEN_POS)
