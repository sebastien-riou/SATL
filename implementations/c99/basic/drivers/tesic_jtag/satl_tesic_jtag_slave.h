#ifndef __SATL_TESIC_JTAG_H__
#define __SATL_TESIC_JTAG_H__

//we have built-in flow control
#define SATL_ACK 0
...
typedef struct SATL_driver_ctx_struct_t {
    volatile struct tpoTapHandle_struct_t*hw;
    uint16_t buf;
    uint32_t buf_level;
} SATL_driver_ctx_t;
